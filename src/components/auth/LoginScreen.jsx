...
function LoginScreen() {
  ...
  return (
    <div class="w-full min-h-screen flex items-center justify-center bg-body text-primary">
      <div class="bg-card p-10 rounded-2xl w-full max-w-[400px] text-center shadow-2xl">
        ...
        <form onSubmit={handleSubmit} class="flex flex-col gap-4 mb-6">
          {isSignUp() && (
            <input 
              ...
              class="p-3 rounded-lg border border-border bg-card text-primary outline-none focus:border-accent transition-colors"
              required={isSignUp()}
            />
          )}
          <input 
          ...
          <input 
            ...
            required 
          />
          <button type="submit" class="p-3 rounded-lg bg-accent text-primary font-semibold border-none cursor-pointer hover:bg-accent/80 transition-colors shadow-lg shadow-accent/20">
        ...
        <div class="my-5 text-secondary text-sm flex items-center gap-4 before:content-[''] before:flex-1 before:h-px before:bg-border after:content-[''] after:flex-1 after:h-px after:bg-border">OR CONTINUE WITH</div>

        <div class="flex flex-col gap-3">
          <button onClick={() => handleOAuth('google')} class="p-3 rounded-lg bg-card text-body font-medium border-none cursor-pointer flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors">
          ...
          <button onClick={() => handleOAuth('azure')} class="p-3 rounded-lg bg-[#00a4ef] text-primary font-medium border-none cursor-pointer flex items-center justify-center gap-2 hover:bg-[#00a4ef]/90 transition-colors">
