...
function LoginScreen() {
  ...
  return (
    <div class="w-full min-h-screen flex items-center justify-center bg-[#0F0F0F] text-[#F3F3F3]">
      <div class="bg-[#1A1A1A] p-10 rounded-2xl w-full max-w-[400px] text-center shadow-2xl">
        ...
        <form onSubmit={handleSubmit} class="flex flex-col gap-4 mb-6">
          {isSignUp() && (
            <input 
              ...
              class="p-3 rounded-lg border border-[#333] bg-[#222] text-white outline-none focus:border-accent transition-colors"
              required={isSignUp()}
            />
          )}
          <input 
          ...
          <input 
            ...
            required 
          />
          <button type="submit" class="p-3 rounded-lg bg-accent text-white font-semibold border-none cursor-pointer hover:bg-accent/80 transition-colors shadow-lg shadow-accent/20">
        ...
        <div class="my-5 text-[#888] text-sm flex items-center gap-4 before:content-[''] before:flex-1 before:h-px before:bg-[#333] after:content-[''] after:flex-1 after:h-px after:bg-[#333]">OR CONTINUE WITH</div>

        <div class="flex flex-col gap-3">
          <button onClick={() => handleOAuth('google')} class="p-3 rounded-lg bg-white text-black font-medium border-none cursor-pointer flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors">
          ...
          <button onClick={() => handleOAuth('azure')} class="p-3 rounded-lg bg-[#00a4ef] text-white font-medium border-none cursor-pointer flex items-center justify-center gap-2 hover:bg-[#00a4ef]/90 transition-colors">
