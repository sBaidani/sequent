...
function AddListModal() {
  ...
  return (
    <Modal id="addList" compact>
      <h2 class="font-display lowercase text-2xl font-extrabold mb-5 text-primary">New List</h2>
      <form onSubmit={handleSubmit} class="flex flex-col gap-4">
        
        <div>
          <label class="font-display lowercase block text-xs text-disabled font-semibold mb-1.5 tracking-wider">List Name</label>
          <input 
            type="text" 
